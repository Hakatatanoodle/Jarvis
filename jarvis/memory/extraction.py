...
knowing this help Nika understand this person?") and allows several
...
_EXTRACTION_SYSTEM = (
    ...
    "WORTH, not shape: would knowing this genuinely help Nika "
    "understand who this person is, what they want, what they value, "
    "or how they'd like Nika to treat them? That includes short "
    ...
    "extract: questions, requests for Nika to do something, small "
    ...
    "anything about Nika itself — its own name, persona, or how it "
    ...
    "something Nika knows ABOUT THEM — a fact about Nika's own "
    ...
    "restates or updates it, the same canonical title lets Nika "
    ...
    "they're doing today) AND did not ask Nika to remember it, or "
