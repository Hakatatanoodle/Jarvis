...
credential wiring exists in this environment for Nika to call out to a
...
_LLM_SYSTEM = (
    "You are Nika's reasoning engine. You receive structured evidence as "
...
def _asserts_wrong_status(text: str, context_items) -> bool:
    ...
    other goals for completeness ("Build Nika is your active project;
    ...
    are exam overloaded and Build Nika, while Make a game, Test, and
