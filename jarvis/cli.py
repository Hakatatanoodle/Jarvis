#!/usr/bin/env python3
"""
Minimal terminal CLI for Nika (architect decision, 2026-08-04, updated
2026-08-08 for V1-M1): "Just enough to talk to Nika from the
...
def _print_help():
    print(
        ...
        "  /help                                this message\n"
        "  /quit, /exit                         leave\n"
        "  <anything else>                      goes through Nika's reasoning pipeline — plain "
...
async def _handle_request(text: str):
    ...
    # makes the turn read as one coherent exchange: Nika responds,
...
async def main():
    await _bootstrap()
    print("Nika V0 — terminal. /help for commands, /quit to leave.")
