...
immediately preceding exchange (Nika's clarifying question + the
...
_EXTRACTION_SYSTEM = (
    ...
    "conversational drift. \"I don't feel like building Nika right "
    ...
    "also shown recent conversation from this session. If Nika's most "
    ...
    "NOT treat a short answer to Nika's own question as an incomplete "
    ...
    "conversation doesn't show Nika asking a Goal/Mission clarifying "
