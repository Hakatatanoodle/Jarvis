...
An AI operating system for one person. Formerly called "Jarvis" during
development (2026-08 through 2026-09) — renamed 2026-09-13; historical
docs (implementation records, RFCs, handover prompts) still say "Jarvis"
throughout and are left as-is, since they're dated record of what was
built and why at the time. See `docs/IMPLEMENTATION_PROMPT.md`
...
`/memory`, `/status`, `/help`); everything else goes through Nika's
